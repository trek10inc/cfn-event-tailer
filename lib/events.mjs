...
function getTerminalWidth() {
  ...
  if (Number.isNaN(numberOfTerminalColumns)) {
    numberOfTerminalColumns = parseInt(process.env.COLUMNS ?? "", 10) || 80;
  }
  return numberOfTerminalColumns;
}
...
function logStackEvent(stackEvent) {
  const numberOfTerminalColumns = getTerminalWidth();
